...
volatile float   g_dbg_spd_target_l_rpm = 0.0f; /* 速度环左轮目标 RPM */
volatile float   g_dbg_spd_target_r_rpm = 0.0f; /* 速度环右轮目标 RPM */
...
static void speed_loop_trim(int16_t *left_cmd, int16_t *right_cmd)
{
    ...
    g_dbg_spd_target_l_rpm = target_l;
    g_dbg_spd_target_r_rpm = target_r;
